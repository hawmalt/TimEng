...
void Player::init(float speed, glm::vec2 pos, TimEng::InputManager* inputManager, TimEng::Camera2D* camera, std::vector<Bullet>* bullets){
	_speed = speed;
	_position = pos;
	_color.r = 255;
	_color.g = 255;
	...
	_bullets = bullets;
	_health = 150;
	m_textureID = TimEng::ResourceManager::getTexture("Textures/player.png").id;
}
